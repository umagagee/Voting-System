 ...
 * @author NANCY
 */
public class VoteOrganizer extends javax.swing.JFrame {
       Connection con=null;
    Statement stm=null;
    ResultSet rs=null;
...
MyQueryOrganizerVote mq = new MyQueryOrganizerVote();
...
jTable1.getColumnModel().getColumn(3).setPreferredWidth(150);
    ...
    private void initComponents() {
        ...
        jLabel1.setText("ORGANIZER VOTING PAGE");
 ...
 try{
     ...
     String query="SELECT VOTES FROM organizervoting WHERE ID='"+vote+"' ";
...
String sql3="Select  * from wucomcandidate";
                 ...
                 rs=ps.executeQuery();
                  if(rs.next()){
                      ...
                      String sql4="Select  * from Treasurecandidate";
                      ...
                      if(rs.next()){
                         VoteTreasure pv = new VoteTreasure();
                          ...
                          String sql5="Select  * from presidentcandidate";
...
setDefaultCloseOperation(JFrame.DO_NOTHING_ON_CLOSE);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VoteOrganizer.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VoteOrganizer().setVisible(true);
            }
        });
    }
