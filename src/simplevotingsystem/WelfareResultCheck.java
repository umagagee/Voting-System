 ...
 * @author UMAGA GEE
 */
public class WelfareResultCheck extends java.awt.Frame {
     Connection con=null;
    Statement stm=null;
    ResultSet rs=null;
...
jTable1.getColumnModel().getColumn(1).setPreferredWidth(150);
 ...
 jTable1.getColumnModel().getColumn(3).setPreferredWidth(0);
  ...
  // String sql1="SELECT * FROM presidentcounter ORDER BY id DESC LIMIT 1;";
                     ...
                     String sql2="SELECT * FROM welfarecandidate,welfarevoting WHERE welfarecandidate.ID=welfarevoting.ID";
...
try{
    ...
    String sql="select FIRSTNAME,LASTNAME,IMAGE from welfarecandidate where   ID='"+hold+"' ";
    ...
    if(rs.next()){
     ...
     String query="SELECT VOTES FROM welfarevoting WHERE ID='"+hold+"' ";
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new WelfareResultCheck().setVisible(true);
            }
        });
    }
...
void showCnadidate(){
try{
    String sql="Select ID from welfarecandidate";
    ps=con.prepareStatement(sql);
    rs=ps.executeQuery();
    while(rs.next()){
