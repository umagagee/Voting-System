 ...
 * @author DELL
 */
public class OrganizerVoting extends javax.swing.JFrame {
    Connection con=null;
    Statement stm=null;
    ResultSet rs=null;
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "ORGANIZER VOTING PAGE", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 48))); // NOI18N
...
String hold=jComboBox1.getSelectedItem().toString();
 ...
 try{
     ...
     int total=holdCurrentVote+counter;
      ...
      String sql= "update organizervoting set  VOTES=? where ID=?";
     ...
     String sql3="Select  * from wucomcandidate";
                 ...
                 rs=ps.executeQuery();
                  if(rs.next()){
                      ...
                      String sql7="Select  * from Treasurecandidate";
 ...
 setDefaultCloseOperation(JFrame.DO_NOTHING_ON_CLOSE);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(OrganizerVoting.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new OrganizerVoting().setVisible(true);
            }
        });
    }
...
void YesNo(){
    ...
    try{
         stm=con.createStatement();
                 String sql3="Select  count(ID) AS Total from organizercandidate";
                 rs=stm.executeQuery(sql3);
                  rs.next();
                  int total=rs.getInt("total");
                  if(total==0){
                      this.setVisible(false);
                      WucomVoting  fv = new    WucomVoting();
                      fv.show();
