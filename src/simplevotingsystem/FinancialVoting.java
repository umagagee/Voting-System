 ...
 * @author DELL
 */
public class FinancialVoting extends javax.swing.JFrame {
    Connection con=null;
    Statement stm=null;
    ResultSet rs=null;
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "FINANCIAL VOTING PAGE", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 48))); // NOI18N
...
String hold=jComboBox1.getSelectedItem().toString();
 ...
 try{
     ...
     String query="SELECT VOTES FROM financialvoting WHERE ID='"+hold+"' ";
     ...
     int total=holdCurrentVote+counter;
      ...
      String sql= "update financialvoting set  VOTES=? where ID=?";
       ...
       ps.executeUpdate();
             ...
             String sql3="Select  * from secertarycandidate";
                 ps=con.prepareStatement(sql3);
                 rs=ps.executeQuery();
                  if(rs.next()){
                       SecretaryVoting pv = new SecretaryVoting();
                            pv.show();
                            this.dispose();
                      }
                  else{
                      String sql7="Select  * from organizercandidate";
                      ps=con.prepareStatement(sql7);
                      rs=ps.executeQuery();
                      if(rs.next()){
                          OrganizerVoting pv = new OrganizerVoting();
                            pv.show();
                            this.dispose();
                          
                                   }
                      else{
                          String sql5="Select  * from wucomcandidate";
                      ps=con.prepareStatement(sql5);
                      rs=ps.executeQuery();
                      if(rs.next()){
                          WucomVoting pv = new WucomVoting();
                            pv.show();
                            this.dispose();
                          
                                   }
                      else {
                          String sql6="Select  * from Treasurecandidate";
...
String hold=jComboBox1.getSelectedItem().toString();
try{
    String sql="select FIRSTNAME,LASTNAME,IMAGE from financialcandidate where   ID='"+hold+"' ";
    ps=con.prepareStatement(sql);
    rs=ps.executeQuery();
    if(rs.next()){
...
try{
     String sql3="Select  * from financialcandidate";
                 ps=con.prepareStatement(sql3);
                 rs=ps.executeQuery();
                  if(rs.next()){
                      FinancialVoting pv = new FinancialVoting();
                            pv.show();
                            this.dispose();
                      }
                  else{
                      String sql7="Select  * from secertarycandidate";
                      ps=con.prepareStatement(sql7);
                      rs=ps.executeQuery();
                      if(rs.next()){
                          SecretaryVoting pv = new SecretaryVoting();
                          ...
                          String sql5="Select  * from organizercandidate";
                      ps=con.prepareStatement(sql5);
                      rs=ps.executeQuery();
                      if(rs.next()){
                          OrganizerVoting pv = new OrganizerVoting();
                          ...
                          String sql6="Select  * from wucomcandidate";
                      ps=con.prepareStatement(sql6);
                      rs=ps.executeQuery();
                      if(rs.next()){
                          WucomVoting pv = new WucomVoting();
                          ...
                          String sql1="Select  * from Treasurecandidate";
 ...
 setDefaultCloseOperation(JFrame.DO_NOTHING_ON_CLOSE);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FinancialVoting.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FinancialVoting().setVisible(true);
            }
        });
    }
...
void PresidentCnadidate(){
    try{
        String sql="SELECT ID FROM financialcandidate";
        ps=con.prepareStatement(sql);
        rs=ps.executeQuery();
        while(rs.next()){
...
void YesNo(){
    ...
    try{
         stm=con.createStatement();
                 String sql3="Select  count(ID) AS Total from financialcandidate";
