 ...
 * @author DELL
 */
public class SecretaryVoting extends javax.swing.JFrame {
    Connection con=null;
    Statement stm=null;
    ResultSet rs=null;
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "SECERTARY VOTING PAGE", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 48))); // NOI18N
...
String hold=jComboBox1.getSelectedItem().toString();
 ...
 try{
     ...
     int total=holdCurrentVote+counter;
      ...
      String sql= "update secertaryvoting set  VOTES=? where ID=?";
       ps=con.prepareStatement(sql);
       ps.setInt(1,total);
       ps.setString(2,jComboBox1.getSelectedItem().toString());
       ps.executeUpdate();
       
       String sql3="Select  * from organizercandidate";
                 ...
                 rs=ps.executeQuery();
                  if(rs.next()){
                      ...
                      String sql7="Select  * from wucomcandidate";
                      ...
                      if(rs.next()){
                          ...
                          String sql5="Select  * from Treasurecandidate";
 ...
 setDefaultCloseOperation(JFrame.DO_NOTHING_ON_CLOSE);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SecretaryVoting.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SecretaryVoting().setVisible(true);
            }
        });
    }
...
void YesNo(){
    ...
    try{
         stm=con.createStatement();
                 String sql3="Select  count(ID) AS Total from secertarycandidate";
                 rs=stm.executeQuery(sql3);
                  rs.next();
                  int total=rs.getInt("total");
                  if(total==0){
                      this.setVisible(false);
                      OrganizerVoting  fv = new    OrganizerVoting();
                      fv.show();
