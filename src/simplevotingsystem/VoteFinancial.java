 ...
 * @author NANCY
 */
public class VoteFinancial extends javax.swing.JFrame {
       Connection con=null;
    Statement stm=null;
    ResultSet rs=null;
...
MyQueryFinancialVote mq = new MyQueryFinancialVote();
...
jTable1.getColumnModel().getColumn(3).setPreferredWidth(150);
    ...
    private void initComponents() {
        ...
        jLabel1.setText("FINANCIAL SERCERTAY CANDIDATE");
 ...
 try{
     ...
     String query="SELECT VOTES FROM financialvoting WHERE ID='"+vote+"' ";
...
String sql3="Select  * from secertarycandidate";
                 ...
                 rs=ps.executeQuery();
                  if(rs.next()){
                      ...
                      String sql4="Select  * from organizercandidate";
                ...
                if(rs.next()){
                      ...
                      if(rs.next()){
                          ...
                          String sql1="Select  * from presidentcandidate";
...
setDefaultCloseOperation(JFrame.DO_NOTHING_ON_CLOSE);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VoteFinancial.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VoteFinancial().setVisible(true);
            }
        });
    }
