 ...
 * @author NANCY
 */
public class VoteTreasure extends javax.swing.JFrame {
       Connection con=null;
    Statement stm=null;
    ResultSet rs=null;
...
MyQueryTreasureVote mq = new MyQueryTreasureVote();
...
jTable1.getColumnModel().getColumn(3).setPreferredWidth(150);
    ...
    private void initComponents() {
        ...
        jLabel1.setText(" TREASURE VOTING PAGE");
 ...
 try{
     ...
     String query="SELECT VOTES FROM treasurevoting WHERE ID='"+vote+"' ";
     ...
     String sql3="Select  * from presidentcandidate";
...
setDefaultCloseOperation(JFrame.DO_NOTHING_ON_CLOSE);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VoteTreasure.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VoteTreasure().setVisible(true);
            }
        });
    }
