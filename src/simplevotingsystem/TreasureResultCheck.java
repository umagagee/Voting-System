 ...
 * @author UMAGA GEE
 */
public class TreasureResultCheck extends java.awt.Frame {
     Connection con=null;
    Statement stm=null;
    ResultSet rs=null;
...
jTable1.getColumnModel().getColumn(1).setPreferredWidth(150);
 ...
 jTable1.getColumnModel().getColumn(3).setPreferredWidth(0);
  ...
  // String sql1="SELECT * FROM presidentcounter ORDER BY id DESC LIMIT 1;";
                     ...
                     String sql2="SELECT * FROM treasurecandidate,treasurevoting WHERE treasurecandidate.ID=treasurevoting.ID";
    ...
    private void initComponents() {
        ...
        jLabel1.setText("TREASURE RESULT");
...
try{
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TreasureResultCheck().setVisible(true);
            }
        });
    }
