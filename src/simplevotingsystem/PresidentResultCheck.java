 ...
 * @author UMAGA GEE
 */
public class PresidentResultCheck extends java.awt.Frame {
     Connection con=null;
    Statement stm=null;
    ResultSet rs=null;
 ...
 jTable1.getColumnModel().getColumn(3).setPreferredWidth(0);
  ...
  // String sql1="SELECT * FROM presidentcounter ORDER BY id DESC LIMIT 1;";
    ...
    private void initComponents() {
        ...
        jLabel1.setText("PRESIDENTIAL RESULT");
        ...
        presidentPanel.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 60, 840, 580));
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addComponent(presidentPanel, javax.swing.GroupLayout.PREFERRED_SIZE, 643, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(0, 0, Short.MAX_VALUE))
        );
...
try{
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PresidentResultCheck().setVisible(true);
            }
        });
    }
