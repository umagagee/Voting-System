 ...
 * @author UMAGAGEE
 */
public class creatConnection extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Connection", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Times New Roman", 1, 36))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(creatConnection.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new creatConnection().setVisible(true);
            }
        });
    }
...
public static  Connection conn(){
    ...
    String serverIP=jTextField1.getText().trim();
...
JOptionPane.showMessageDialog(null, "COnnection Fail Check Credentials");
System.exit(0);
//LogIn n = new LogIn();
//n.setVisible(false);
