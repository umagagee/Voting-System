 ...
 * @author NANCY
 */
public class VoteWelfare extends javax.swing.JFrame {
       Connection con=null;
    Statement stm=null;
    ResultSet rs=null;
...
MyQueryWelfareVote mq = new MyQueryWelfareVote();
...
jTable1.getColumnModel().getColumn(3).setPreferredWidth(150);
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Welfare Candidate PAGE");
 ...
 try{
     ...
     String query="SELECT VOTES FROM welfarevoting WHERE ID='"+vote+"' ";
     ...
     int total=holdCurrentVote+counter;
      ...
      String sql= "update welfarevoting set  VOTES=? where ID=?";
    ...
    String sql3="Select  * from financialcandidate";
                 ...
                 rs=ps.executeQuery();
                  if(rs.next()){
                      ...
                      String sql4="Select  * from secertarycandidate";
                ...
                if(rs.next()){
                      ...
                      if(rs.next()){
                          ...
                          String sql2="Select  * from presidentcandidate";
                      ps=con.prepareStatement(sql2);
                      rs=ps.executeQuery();
                      if(rs.next()){
...
setDefaultCloseOperation(JFrame.DO_NOTHING_ON_CLOSE);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VoteWelfare.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VoteWelfare().setVisible(true);
            }
        });
    }
...
void YesNo(){
    ...
    try{
         stm=con.createStatement();
                 String sql3="Select  count(ID) AS Total from welfarecandidate";
