 ...
 * @author DELL
 */
public class TreasureVoting extends javax.swing.JFrame {
    Connection con=null;
    Statement stm=null;
    ResultSet rs=null;
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "TREASURE VOTING PAGE", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 48))); // NOI18N
...
String hold=jComboBox1.getSelectedItem().toString();
 ...
 try{
     ...
     String query="SELECT VOTES FROM treasurevoting WHERE ID='"+hold+"' ";
     ...
     int total=holdCurrentVote+counter;
      ...
      String sql= "update treasurevoting set  VOTES=? where ID=?";
...
String hold=jComboBox1.getSelectedItem().toString();
try{
    String sql="select FIRSTNAME,LASTNAME,IMAGE from treasurecandidate where   ID='"+hold+"' ";
    ps=con.prepareStatement(sql);
    rs=ps.executeQuery();
    if(rs.next()){
 ...
 setDefaultCloseOperation(JFrame.DO_NOTHING_ON_CLOSE);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TreasureVoting.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TreasureVoting().setVisible(true);
            }
        });
    }
...
void PresidentCnadidate(){
    try{
        String sql="SELECT ID FROM treasurecandidate";
        ps=con.prepareStatement(sql);
        rs=ps.executeQuery();
        while(rs.next()){
...
void YesNo(){
    ...
    try{
         stm=con.createStatement();
                 String sql3="Select  count(ID) AS Total from treasurecandidate";
