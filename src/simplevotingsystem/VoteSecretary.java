 ...
 * @author NANCY
 */
public class VoteSecretary extends javax.swing.JFrame {
       Connection con=null;
    Statement stm=null;
    ResultSet rs=null;
...
MyQuerySecretaryVote mq = new MyQuerySecretaryVote();
...
jTable1.getColumnModel().getColumn(3).setPreferredWidth(150);
    ...
    private void initComponents() {
        ...
        jLabel1.setText("GENERAL SECRETARY CANDIDATE");
 ...
 try{
     ...
     String query="SELECT VOTES FROM secertaryvoting WHERE ID='"+vote+"' ";
...
String sql3="Select  * from organizercandidate";
                 ...
                 rs=ps.executeQuery();
                  if(rs.next()){
                      ...
                      String sql4="Select  * from wucomcandidate";
                ...
                if(rs.next()){
                          ...
                          String sql6="Select  * from presidentcandidate";
...
setDefaultCloseOperation(JFrame.DO_NOTHING_ON_CLOSE);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VoteSecretary.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VoteSecretary().setVisible(true);
            }
        });
    }
